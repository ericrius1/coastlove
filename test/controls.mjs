...
e.inputCaptured=true;assert.equal(vehicles.interact(),false,'map captures E without pausing simulation');e.inputCaptured=false;
...
console.log('ok single-press car/boat/deck/plane entry and exit, water re-entry, map input capture and safe landing failures');
